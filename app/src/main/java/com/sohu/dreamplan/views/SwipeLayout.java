...
public class SwipeLayout extends FrameLayout implements SwipeLayoutInterface{
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		// 返回true则为拦截
		Log.i("touch", "SwipeLayout onInterceptTouchEvent-- action=" + ev.getAction());
		return  mDragHelper.shouldInterceptTouchEvent(ev) & mGestureDetector.onTouchEvent(ev);
	};

	@Override
	public boolean dispatchTouchEvent(MotionEvent ev) {
		Log.i("touch", "SwipeLayout dispatchTouchEvent-- action=" + ev.getAction());
		return super.dispatchTouchEvent(ev);
	}

	@Override
	public boolean onTouchEvent(MotionEvent event) {
		Log.i("touch", "SwipeLayout onTouchEvent-- action=" + event.getAction());
